...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function authPaymob()
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->authPaymob();
        }
                    /**
         ...
         * @static 
         */ 
        public static function makeOrderPaymob($token, $merchant_id, $amount_cents, $merchant_order_id)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->makeOrderPaymob($token, $merchant_id, $amount_cents, $merchant_order_id);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getPaymentKeyPaymob($token, $amount_cents, $order_id, $email = 'null', $fname = 'null', $lname = 'null', $phone = 'null', $city = 'null', $country = 'null')
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->getPaymentKeyPaymob($token, $amount_cents, $order_id, $email, $fname, $lname, $phone, $city, $country);
        }
                    /**
         ...
         * @static 
         */ 
        public static function makePayment($token, $card_number, $card_holdername, $card_expiry_mm, $card_expiry_yy, $card_cvn, $order_id, $firstname, $lastname, $email, $phone)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->makePayment($token, $card_number, $card_holdername, $card_expiry_mm, $card_expiry_yy, $card_cvn, $order_id, $firstname, $lastname, $email, $phone);
        }
                    /**
         ...
         * @static 
         */ 
        public static function capture($token, $transactionId, $amount)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->capture($token, $transactionId, $amount);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getOrders($authToken, $page = 1)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->getOrders($authToken, $page);
        }
                    /**
         * Get PayMob order.
         *
         ...
         * @static 
         */ 
        public static function getOrder($authToken, $orderId)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->getOrder($authToken, $orderId);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getTransactions($authToken, $page = 1)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->getTransactions($authToken, $page);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getTransaction($authToken, $transactionId)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->getTransaction($authToken, $transactionId);
        }
                    /**
         ...
         * @static 
         */ 
        public static function sample($method = null)
        {
                        /** @var \BaklySystems\PayMob\PayMob $instance */
                        return $instance->sample($method);
        }
...
namespace  { 
            ...
            class PayMob extends \BaklySystems\PayMob\Facades\PayMob {}
