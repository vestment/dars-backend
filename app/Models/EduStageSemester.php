...
class EduStageSemester extends Model
{
    ...
    public function courses(){
        ...
        return $this->belongsToMany(Course::class,'course_edu_statge_sems','edu_statge_sem_id','course_id')->with('category','teachers','year','publishedLessons')->where('year_id',$lastYear->id);
    }
