...
class Lesson extends Model
{
    ...
    protected $fillable = ['title','title_ar', 'slug', 'lesson_image', 'short_text', 'full_text', 'short-text-ar', 'full_text_ar', 'position', 'downloadable_files', 'free_lesson', 'published', 'course_id','chapter_id'];
