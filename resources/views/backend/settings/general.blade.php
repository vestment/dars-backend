                ...
                <div id="general" class="tab-pane container active">
                    <div class="row mt-4 mb-4">
                        <div class="col ">
                            ...
                            <div class="form-group row">
                                {{ html()->label(__('validation.attributes.backend.settings.general_settings.phone_confirmation'))->class('col-md-2 form-control-label')->for('less') }}
                                <div class="col-md-10">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('phone_confirmation', config('phone_confirmation') ? true : false,1)->id('retest')
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="switch-content @if(config('paymob.active') == 0 || config('paymob.active') == false) d-none @endif">
                                        ...
                                        <div class="form-group row">
                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.iframe_id'))->class('col-md-2 form-control-label')->for('paymob__iframe_id') }}
                                            <div class="col-md-8 col-xs-12">
                                                {{ html()->input('number','paymob__iframe_id')
                                                     ->class('form-control')
                                                     ->value(config('paymob.iframe_id'))
                                                     }}
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        <div class="form-group row">
