...
<div class="title my-3 mx-5">            <h3 class="page-title d-inline mb-5">@lang('labels.backend.bundles.title')</h3>
</div>
    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table id="myTable"
                       class="border-0 shadow-lg @can('course_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                    <thead class="thead">
                    <tr>
