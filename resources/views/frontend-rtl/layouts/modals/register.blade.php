          ...
          <form action="{{route('frontend.auth.register.post')}}"
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label class="form-check-label" for="exampleCheck1"> @lang('labels.frontend.sign_up.agreement')</label>
              </div>
              </div>
            </div>
            <button type="submit" class="btn loginBtn text-white col-12 mt-5">@lang('labels.frontend.sign_up.sign_up')</button>
          </form>
            <div><a href="{{ route('loginrtl.indexrtl') }}" class="text-dark col-12 d-flex justify-content-center mt-5">@lang('labels.frontend.sign_up.already_have_account')</a></div>
            <div class="mb-2"><a href="#" class="text-dark col-12 d-flex justify-content-center mt-3">@lang('labels.frontend.sign_up.terms_of_use')</a></div>
        
        </div>  
        </div>
      </div>
      <div  class="col-md-6 imgDivReg"></div>
    </div>
</body>
</html>    