...
@push('after-styles')
<link rel="stylesheet" href="../../assets-rtl/css/frontend-rtl.css"/>
...
@section('content')
    ...
    <section id="breadcrumb" class="breadcrumb-section relative-position backgroud-style bgcolor">
        <div class="blakish-overlay"></div>
            <div class="container">
                <div class="col m-5 p-3 paragraph1 text-right">
                   <!-- course category -->
                    <div class="m-1">    
    ...
    <section id="course-page" class="course-page-section">
        <div class="container text-right">
            <div class="row col-lg-8 col-sm-12 coursesec d-block m-2 text-right float-right">
            ...
            <div class="row  coursesec d-block m-3 text-right">
                <h2 > Requirements</h2>
            </div>
            ...
            <div class="col-4 m-5 shadow-lg divfixed paddingleft float-left">
                <!-- Grid row -->
                <a>
...
<section id="course-page" class="course-page-section">
    <div class="container text-right">
        ...
        <div class="row smpara d-block m-2 text-right">
            ...
            <div class="accordion" id="accordionExample">
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <h2 class="mb-0">
                        <button class="btn btn-link btn-block text-right" type="button" data-toggle="collapse" data-target="#{{$chapter->id}}" aria-expanded="true" aria-controls="{{$chapter->id}}" >
                        {{ $chapter->title}} <i class="fa fa-angle-down float-left" aria-hidden="true"></i>
                        </button>
 ...
 <section id="course-page" class="course-page-section">
    <div class="container">
        <div class="course-review">
            <div class="section-title-2 mb20 headline text-right">
