...
@section('content')
<div class="title my-3 mx-5">            <h3 class="page-title d-inline mb-5">@lang('labels.backend.questions.title')</h3>
</div>
    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <div class="card-body table-responsive">
            ...
            <table id="myTable"
                   class="border-0 shadow-lg @if ( request('show_deleted') != 1 ) dt-select @endif ">
                <thead class="thead">
                <tr>
                    @can('question_delete')
