...
@section('content')
    <div class="title mb-4 mx-5">
        <h1 class="page-title d-inline mb-5">@lang('labels.backend.reports.fields.students')</h1>
        @can('user_create')
    </div>
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.actions').html('<a href="' + '{{ route('admin.students.mass_destroy') }}' + '" class="btn btn-blue js-delete-selected" style="margin-top:0.755em;margin-left: 20px;">Delete selected</a>');
            @endif
        });
