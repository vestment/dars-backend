    ...
    <section id="course-page" class="course-page-section">
        ...
        <div class="row">
            @if(@isset($category))
                ...
                <ul class="nav nav-tabs popular-navs" id="myTab" role="tablist">
                        <li class="nav-item " role="presentation">
                          <a class="nav-link active act-pop " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Most popular</a>
                        </li>
                        <li class="nav-item" role="presentation">
                          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Trending</a>
                        </li>
                        <li></li>
                      </ul>
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> 
                            <div class="owl-carousel default-default-owl-theme">
                                ...
                                <div class="best-course-pic-text relative-position">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title titleofcard">{{$course->title}}</h3>
                                            <div class="row">
                                                <div class="col-12">
                                                        <img  src="{{url('img/frontend/user/star.png')}}" class="d-inline sta">
                                                        <img  src="{{url('img/frontend/user/star.png')}}" class="d-inline sta">
                                                        <img  src="{{url('img/frontend/user/star.png')}}" class="d-inline sta">
                                                        <img  src="{{url('img/frontend/user/star.png')}}" class="d-inline sta">
                                                        <img  src="{{url('img/frontend/user/star.png')}}" class="d-inline sta">
