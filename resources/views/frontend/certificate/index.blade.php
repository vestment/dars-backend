...
<div class="container-fluid px-0" style="height: 500px">
    <div style="position: relative;text-align: center"
        ...
        <div class="col-12 text-block align-self-center">
            <p class="text-center mb-0">This is to certify that <span class="font-weight-bold">{{$data['name']}}</span> successfully completed
            </p>
            <p style="word-wrap: break-word;white-space: nowrap"><span class="font-weight-bold">{{$data['course_name']}}</span>
            </p>
            <p  style="word-wrap: break-word;white-space: nowrap">on <span class="font-weight-bold">{{config('app.name')}}</span> online course on <span class="font-weight-bold">{{$data['date']}}</span></p>
        </div>
