...
<div class="tab-content" id="{{$category->id}}">
@foreach($categories as $key=>$category)


  <div class="tab-pane fade show @if ($key == 0) active @endif" id="content-{{$category->id}} " role="tabpanel" aria-labelledby="content-{{$category->id}}">
