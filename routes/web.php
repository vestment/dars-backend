...
Route::get('test/{slug}', 'CoursesController@player')->name('testVue.show');
...
Route::get('filter/courses', ['uses' => 'CoursesController@filerCoursesByCategory', 'as' => 'courses.filterCategory']);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('lesson/notes', 'LessonsController@getNotes')->name('notes.index');
